...
const Contactus = React.createClass({
	...
	render(){
		...
		return(
      <div className="container" style={{minHeight: '450px',fontSize: '20px', fontFamily: 'Glyphicons Halflings',fontWeight: '400'}}>
        ...
        <div className='row'>
          ...
          <div className="col-lg-4">
            ...
            <div className='contact-1'>
              ...
              <strong style={{color:'#e8554e'}}>Email: </strong><br/>
               JustCars@gmail.com <br/><br/>
              <strong style={{color:'#e8554e'}}>Phone: </strong><br/> 
              646-360-14-14<br/><br/>
              <strong style={{color:'#e8554e'}}>Address: </strong><br/>
          ...
          <div className='pull-right contact-2'>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96781.14750262722!2d-74.08738762517704!3d40.70897103497913!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a101784a785%3A0x848f182853fe1813!2sNyc+Parts+Inc!5e0!3m2!1sen!2sus!4v1482692463894" width="700" height="400"></iframe>  
           </div>
          </div>
        </div>
